...
/**
 * @title IRMRKExternalEquipUpgradeable
 * @author RMRK team
 * @notice Interface smart contract of the upgradeable RMRK external equippable module.
 */
interface IRMRKExternalEquipUpgradeable is IERC6220Upgradeable {
    /**
