...
/**
 * @title IRMRKCatalogUpgradeable
 * @author RMRK team
 * @notice An upgradeable interface Catalog for RMRK equippable module.
 */
interface IRMRKCatalogUpgradeable is IERC165Upgradeable {
    /**
