 ...
 * @author RMRK team
 * @notice Interface smart contract of the upgradeable RMRK MultiAsset AutoIndex module.
 */
interface IRMRKMultiAssetAutoIndexUpgradeable is IERC5773Upgradeable {
    /**
