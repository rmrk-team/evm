...
import "../../../RMRK/extension/tokenProperties/RMRKTokenPropertiesUpgradeable.sol";

/**
 * @title RMRKTokenPropertiesMockUpgradeable
 * @author RMRK team
 * @notice Smart contract of the upgradeable RMRK Token properties module.
 */
contract RMRKTokenPropertiesMockUpgradeable is RMRKTokenPropertiesUpgradeable {
    /**
