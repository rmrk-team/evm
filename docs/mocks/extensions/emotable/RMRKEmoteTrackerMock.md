...
```solidity
function presignedEmote(address emoter, address collection, uint256 tokenId, bytes4 emoji, bool on, uint256 deadline, uint8 v, bytes32 r, bytes32 s) external nonpayable
```
