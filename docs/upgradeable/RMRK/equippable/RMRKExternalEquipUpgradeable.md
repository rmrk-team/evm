# RMRKExternalEquipUpgradeable

*RMRK team*

> RMRKExternalEquipUpgradeable

Smart contract of the upgradeable RMRK External Equippable module.

*This smart contract is expected to be paired with an instance of `RMRKNestableExternalEquipUpgradeable`.*
