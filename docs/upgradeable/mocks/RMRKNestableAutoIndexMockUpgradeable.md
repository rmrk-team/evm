# RMRKNestableAutoIndexMockUpgradeable
...
### __RMRKNestableAutoIndexMockUpgradeable_init

```solidity
function __RMRKNestableAutoIndexMockUpgradeable_init(string name_, string symbol_) external nonpayable
```
