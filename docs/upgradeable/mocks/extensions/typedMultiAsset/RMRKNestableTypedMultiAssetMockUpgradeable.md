# RMRKNestableTypedMultiAssetMockUpgradeable
...
### __RMRKNestableMultiAssetMockUpgradeable_init

```solidity
function __RMRKNestableMultiAssetMockUpgradeable_init(string name, string symbol) external nonpayable
```
...
### __RMRKNestableTypedMultiAssetMockUpgradeable_init

```solidity
function __RMRKNestableTypedMultiAssetMockUpgradeable_init(string name, string symbol) external nonpayable
```
