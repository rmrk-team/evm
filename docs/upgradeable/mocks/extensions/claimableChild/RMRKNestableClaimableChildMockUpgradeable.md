# RMRKNestableClaimableChildMockUpgradeable
...
### __RMRKNestableClaimableChildMockUpgradeable_init

```solidity
function __RMRKNestableClaimableChildMockUpgradeable_init(string name, string symbol) external nonpayable
```
