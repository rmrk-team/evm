...
*RMRK nesting implementation. This contract is hierarchy agnostic, and can support an arbitrary number of nested levels up and down, as long as gas limits allow*
