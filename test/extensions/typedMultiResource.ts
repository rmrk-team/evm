...
describe('RMRKNestingTypedMultiResourceMock', async function () {
  ...
  it('can support INesting', async function () {
    expect(await typedNestingMultiResource.supportsInterface('0xc61f8b39')).to.equal(true);
  });
...
describe('RMRKTypedEquippableMock', async function () {
  ...
  it('can support INesting', async function () {
    expect(await typedEquippable.supportsInterface('0xc61f8b39')).to.equal(true);
  });
