...
async function typeMultiAssetFixture() {
  const factory = await ethers.getContractFactory('RMRKTypedMultiAssetMockUpgradeable');
  const typedMultiAsset = await upgrades.deployProxy(factory, ['Chunky', 'CHNK']);
...
describe('RMRKTypedMultiAssetMockUpgradeable', async function () {
  ...
  describe('RMRKTypedMultiAssetMockUpgradeable get top assets', async function () {
